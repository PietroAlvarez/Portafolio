...
export class TranslationService {
  ...
  private translations: Translations = {
    ...
    "projects.reservalab.title": { es: "ReservaLab · Gestión de laboratorio TI", en: "ReservaLab · IT lab management", it: "ReservaLab · Gestione laboratorio IT" },
    "projects.reservalab.desc": { es: "Agenda de reservas y panel de gestión para un laboratorio de computación. Incluye solicitudes, tareas de soporte, estado de servicios, inventario y un modo demostración seguro.", en: "Reservation calendar and management dashboard for a computer lab, including requests, support tasks, service status, inventory and a safe demo mode.", it: "Agenda delle prenotazioni e pannello di gestione per un laboratorio informatico, con richieste, attività di supporto, stato dei servizi, inventario e una modalità demo sicura." },
